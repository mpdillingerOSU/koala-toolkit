...
///Below is copied source code that simply makes the [AppBarState] be public
...
class PublicAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and [automaticallyImplyLeading] must
  ...
  @override
  State<PublicAppBar> createState() => PublicAppBarState();
}

class PublicAppBarState extends State<PublicAppBar> {
...
class _AppBarTitleBox extends SingleChildRenderObjectWidget {
  const _AppBarTitleBox({super.key, required Widget child})
      : super(child: child);
